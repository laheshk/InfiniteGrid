(function() {
    ...
    splitCurrentRect () {
      if (this.currentRects.length) {
        ...
        if (cutSide > this.gridMin * 2) {
          const rect1Size = (this.gridMin, cutSide - this.gridMin)
  ...
  function loadTextureForImage (index) {
    ...
    const url = `https://source.unsplash.com/collection/2737036/${image.width}x${image.height}`
    // var url = [`http://i.imgur.com/T55muMD.png`, 'https://i.imgur.com/uFmsA.png']
